...
execute as @s[scores={TBtimer=139},nbt={UUID:[I;830775973,-2059124427,-1980963265,-677121745]}] if data storage os1:trapper colors[0] at @s run execute as @e[distance=..0.1,limit=1,tag=tnttrack] at @s run function game:tournament_rewards/os1/tracking_bomb/init
